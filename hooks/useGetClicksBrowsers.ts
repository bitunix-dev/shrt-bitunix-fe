...
const fetchClicksBrowsers = async (): Promise<ApiResponse> => {
  try {
...
export const useGetClicksBrowsers = () => {
  return useQuery<ApiResponse>({
    queryKey: ["analytics/browsers"], // Key unik untuk caching
    queryFn: fetchClicksBrowsers,
